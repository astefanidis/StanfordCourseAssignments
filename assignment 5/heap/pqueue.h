...
/* Instance variables */
   ...
   int count;
   int capacity;
   int totalCount;  //totalCount marks how many enqueues happened, to compare effectively in case of equal priorities
                    //(showing who arrived first)
   ...
   void upheap();
   void downheap();
   int findMinChild(int leftChild, int rightChild);
